...
import state.mn.us.dhs.IntegrationTest;
import state.mn.us.dhs.config.Constants;
import state.mn.us.dhs.domain.User;
import state.mn.us.dhs.repository.AuthorityRepository;
...
import state.mn.us.dhs.service.dto.PasswordChangeDTO;
import state.mn.us.dhs.web.rest.vm.KeyAndPasswordVM;
import state.mn.us.dhs.web.rest.vm.ManagedUserVM;
